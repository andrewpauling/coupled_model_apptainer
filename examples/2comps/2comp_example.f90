program atm_ocean_coupling
  ...
  type(ESMF_FieldBundle) :: fb_atm, fb_ocn
  type(ESMF_State) :: state_atm, state_ocn
  type(ESMF_VM) :: vm
  type(ESMF_RouteHandle) :: rh_atm2ocn, rh_ocn2atm
  type(ESMF_Field) :: fld_atm_flux, fld_ocn_flux, fld_atm_sst, fld_ocn_sst
  integer :: rc
  ...
  call ESMF_FieldBundleAdd(fb_atm, (/fld_atm_flux, fld_atm_sst/), rc=rc)
  call ESMF_FieldBundleAdd(fb_ocn, (/fld_ocn_flux, fld_ocn_sst/), rc=rc)
  ...
  !------------------------------------------------------------
  ! 4. Initialize fields
  call initialize_fields(fld_atm_flux, fld_atm_sst, fld_ocn_flux, fld_ocn_sst)
...
contains
  ...
  subroutine initialize_fields(fld_atm_flux, fld_atm_sst, fld_ocn_flux, fld_ocn_sst)
    type(ESMF_Field), intent(inout) :: fld_atm_flux, fld_atm_sst, fld_ocn_flux, fld_ocn_sst
    real(8), pointer :: ptr(:,:)
    integer :: rc
